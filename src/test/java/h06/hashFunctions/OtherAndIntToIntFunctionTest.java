...
public class OtherAndIntToIntFunctionTest extends TestClass {

    public final Method apply, getTableSize, setTableSize;

    public OtherAndIntToIntFunctionTest() {
        super("h06.hashFunctions.OtherAndIntToIntFunction", null);

        apply = getMethodByName("apply(T, int)");
